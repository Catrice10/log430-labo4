...
counter_highest_spending = Counter('highest_spending', 'Total calls to /orders/reports/highest-spenders')
counter_best_selling = Counter('best_selling', 'Total calls to /orders/reports/best-sellers')
